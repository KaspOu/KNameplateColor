...
function KNCUI.CheckboxWidget_OnClick(self)
...
function KNCUI.CheckboxWidget_OnLoad(self)
	self.type = "checkbox";
...
function KNCUI.CheckboxWidget_OnEnter(self)
...
function KNCUI.CheckboxWidget_OnLeave(self)
	-- GameTooltip:Hide();
end
...
function KNCUI.HeadingWidget_OnLoad (self)
...
function KNCUI.HeadingWidget_OnClick(self)
...
function KNCUI.ColorWidget_OnLoad (self)
	self.type = "color";
...
function KNCUI.ColorWidget_OnClick(self)
...
function KNCUI.ColorWidget_OnEnter(self)
	if (not self:IsEnabled()) then return end;
	local text = self:GetAttribute("text") or self:GetAttribute("title") or "";
	local tooltip = self:GetAttribute("tooltip") or "";
	showTooltip(self, text, tooltip, "ANCHOR_RIGHT")
end
function KNCUI.ColorWidget_OnLeave(self)
	GameTooltip:Hide();
end
...
function KNCUI.SliderWidget_OnLoad (self)
...
function KNCUI.SliderWidget_OnValueChanged(self, value)
...
function KNCUI.SliderWidget_OnEnter(self)
	if (not self:IsEnabled()) then return end;
	local text = self:GetAttribute("text") or self:GetAttribute("title") or ""
	local tooltip = self:GetAttribute("tooltip") or ""
	showTooltip(self, text, tooltip, "ANCHOR_TOP")
end
function KNCUI.SliderWidget_OnLeave(self)
	GameTooltip:Hide();
end
...
function KNCUI.DropDownWidget_OnLoad(self)
	self.type = "dropdown";
...
function KNCUI.DropDownWidget_OnEnter(self)
...
function KNCUI.DropDownWidget_OnLeave(self)
	GameTooltip:Hide();
end
