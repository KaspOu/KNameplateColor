...
function ns.SaveOptions(defaultOptions, ComputedReloadOptions)
    local LastComputedReloadOptions = ComputedReloadOptions and ComputedReloadOptions() or nil;
    ...
    if ComputedReloadOptions and ComputedReloadOptions() ~= LastComputedReloadOptions then
